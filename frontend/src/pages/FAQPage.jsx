      ...
      <div className="mx-auto space-y-4">
          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                us at support@example.com with your order number and a
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                support@example.com, or by calling us at 9876543210
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 6 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                Currently, we only offer shipping within theKathmandu Valley.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 7 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                We accept esewa  payment method also we have
